...
function calculateSolar() {
    ...
    //console.log(panelInfo[0]);
    //console.log(panelInfo[1]);
    var panelNeeded = Math.ceil(realWattNeeds/panelOutput);
    //console.log(panelNeeded);
    
    var feedback = '';
    feedback += "<p>Based on your average daily use of " + Math.round(dailyUseKw) + " kWh, you will need to purchase " + panelNeeded + " " + panelName + " solar panels to offset 100% of your electricity bill.</p>";
